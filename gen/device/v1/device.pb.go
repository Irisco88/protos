...
type IOElement struct {
	...
	ElementLable string  `protobuf:"bytes,2,opt,name=element_lable,json=elementLable,proto3" json:"element_lable,omitempty"`
...
func (x *IOElement) GetElementLable() string {
	if x != nil {
...
var file_device_v1_device_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x5f, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c,
