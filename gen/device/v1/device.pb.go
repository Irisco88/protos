...
type Value struct {
	...
	ElementValue int64  `protobuf:"varint,2,opt,name=element_value,json=elementValue,proto3" json:"element_value,omitempty"`
}
...
func (x *Value) GetElementValue() int64 {
	if x != nil {
...
var file_device_v1_device_proto_rawDesc = []byte{
	...
	0x74, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x65,
